"""
MEMEBOT 2D Character Renderer - Drawing Module Part 2
Standing character, Laying character, Arms, Hands, Head, Eyes, Nose, Mouth, Ears
Part 2 of 2
"""
...
def draw_standing_character(renderer, draw, c, cfg, cx, ground_y, leg_swing, arm_swing, 
    ...
    from character_renderer_accessories_part1 import draw_tail, draw_cape, draw_wings, draw_scarf
    from character_renderer_accessories_part2 import (draw_hat, draw_mask, draw_glasses, draw_shirt,
                                                       draw_pants, draw_shoes, draw_outfit_details)
    from character_drawing_part1 import draw_legs, draw_torso
    ...
    if outfit_type == "none":
        body_color = c["skin"]; body_outline_color = c["skin_outline"]
    elif outfit_type == "armor":
        body_color = (180, 180, 200, 255); body_outline_color = (140, 140, 160, 255)
    elif outfit_type == "suit":
        body_color = (30, 30, 50, 255); body_outline_color = (15, 15, 30, 255)
    elif outfit_type == "robe":
        body_color = (120, 60, 140, 255); body_outline_color = (80, 30, 100, 255)
    elif outfit_type == "space_suit":
        body_color = (200, 200, 220, 255); body_outline_color = (150, 150, 170, 255)
    elif outfit_type == "ninja":
        body_color = (20, 20, 30, 255); body_outline_color = (10, 10, 15, 255)
    elif outfit_type == "swimwear":
        body_color = c["skin"]; body_outline_color = c["skin_outline"]
    elif outfit_type == "overalls":
        body_color = (80, 120, 200, 255); body_outline_color = (50, 80, 150, 255)
    elif outfit_type == "tuxedo":
        body_color = (20, 20, 30, 255); body_outline_color = (10, 10, 20, 255)
    elif outfit_type == "raincoat":
        body_color = (255, 255, 100, 255); body_outline_color = (200, 200, 60, 255)
    elif outfit_type == "kimono":
        body_color = (200, 50, 80, 255); body_outline_color = (150, 30, 50, 255)
    elif outfit_type == "military":
        body_color = (60, 80, 40, 255); body_outline_color = (40, 50, 25, 255)
    elif outfit_type == "pirate":
        body_color = (80, 20, 30, 255); body_outline_color = (50, 10, 15, 255)
    elif outfit_type == "cyberpunk":
        body_color = (40, 40, 80, 255); body_outline_color = (0, 255, 200, 255)
    elif outfit_type == "steampunk":
        body_color = (100, 70, 40, 255); body_outline_color = (180, 140, 40, 255)
        ...
        body_color = outfit_primary; body_outline_color = outfit_secondary
...
def draw_head(renderer, draw, c, head_cfg, hair_cfg, clothing, 
    ...
    from character_renderer_accessories_part2 import draw_hair_style, draw_hat, draw_mask, draw_glasses
...
def draw_ears(renderer, draw, c, body_color, body_outline_color, head_cfg, cx, head_y, head_size_mult, extra_spin):
    ...
    from character_renderer_accessories_part2 import draw_ear_style
